      ...
      {showPaceEditor1 && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            <h3 className="text-xl font-bold mb-4">Adjust Custom Pace</h3>
            
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Enter custom months to complete for each level. Leave blank to use default pace.
              </p>

              <div>
                <h4 className="font-semibold mb-2">Math Levels:</h4>
                <div className="grid grid-cols-2 gap-2">
                  {MATH_LEVELS.map((level) => (
                    <div key={level} className="flex items-center gap-2">
                      <label className="w-16">{level}:</label>
                      <input
                        type="number"
                        min="1"
                        max="50"
              ...
              <div>
                <h4 className="font-semibold mb-2">English Levels:</h4>
                <div className="grid grid-cols-2 gap-2">
